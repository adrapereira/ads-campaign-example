...
import ai.nanos.test.config.Constants;
import ai.nanos.test.NanosApp;
import ai.nanos.test.domain.Authority;
import ai.nanos.test.domain.User;
import ai.nanos.test.repository.AuthorityRepository;
import ai.nanos.test.repository.UserRepository;
import ai.nanos.test.security.AuthoritiesConstants;
import ai.nanos.test.service.MailService;
import ai.nanos.test.service.dto.UserDTO;
import ai.nanos.test.service.dto.PasswordChangeDTO;
import ai.nanos.test.web.rest.errors.ExceptionTranslator;
import ai.nanos.test.web.rest.vm.KeyAndPasswordVM;
import ai.nanos.test.web.rest.vm.ManagedUserVM;
import ai.nanos.test.service.UserService;
