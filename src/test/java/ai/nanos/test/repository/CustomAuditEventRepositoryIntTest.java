...
import ai.nanos.test.config.audit.AuditEventConverter;
import ai.nanos.test.domain.PersistentAuditEvent;
...
import static ai.nanos.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
