...
import { NanosLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: NanosLoginModalComponent;
        let fixture: ComponentFixture<NanosLoginModalComponent>;
        ...
        beforeEach(
            async(() => {
                TestBed.configureTestingModule({
                    ...
                    declarations: [NanosLoginModalComponent],
                    providers: [
                        {
                    ...
                    .overrideTemplate(NanosLoginModalComponent, '')
                    .compileComponents();
            })
        );

        beforeEach(() => {
            fixture = TestBed.createComponent(NanosLoginModalComponent);
